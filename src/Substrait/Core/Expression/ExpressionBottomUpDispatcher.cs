// <copyright file="ExpressionBottomUpDispatcher.cs" company="Microsoft">
...
/// <summary>
/// Dispatcher for traversing expression trees following a bottom-up traversal strategy.
/// </summary>
...
public class ExpressionBottomUpDispatcher<TContext, TOutput> : IDispatcher<IExpression, TContext, TOutput>
    where TContext : IContext<IExpression, TOutput>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ExpressionBottomUpDispatcher{TContext, TOutput}"/> class.
    /// </summary>
    /// <param name="visitor">The visitor used to process nodes during traversal.</param>
    /// <param name="traversal">Bottom up traversal.</param>
    public ExpressionBottomUpDispatcher(ExpressionVisitor<TContext, TOutput> visitor, BottomUpTraversal<IExpression> traversal)
    {
        this.visitor = visitor;
        this.traversalStrategy = traversal;
    }
    ...
    /// </summary>
    /// <param name="visitor">The visitor used to process nodes during traversal.</param>
    public ExpressionBottomUpDispatcher(ExpressionVisitor<TContext, TOutput> visitor)
        : this(visitor, new BottomUpTraversal<IExpression>())
    {
    }

// <copyright file="RelTopDownDispatcher.cs" company="Microsoft">
...
/// <summary>
/// Dispatcher for traversing relational operator trees following a top-down traversal strategy.
/// </summary>
...
public class RelTopDownDispatcher<TContext, TOutput> : IDispatcher<IRel, TContext, TOutput>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RelTopDownDispatcher{TContext, TOutput}"/> class.
    /// </summary>
    /// <param name="visitor">The visitor used to process nodes during traversal.</param>
    public RelTopDownDispatcher(RelVisitor<TContext, TOutput> visitor)
    {
        this.visitor = visitor;
        this.traversalStrategy = new TopDownTraversal<IRel>();
    }
